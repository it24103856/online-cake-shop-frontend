                ...
                <div className="max-w-xl mx-auto">
                    <form onSubmit={handleSubmit} className="bg-white p-8 md:p-12 rounded-[3rem] shadow-2xl border border-rose-50">
                        ...
                        <div className="relative mb-8">
                            <textarea
                                className="w-full p-6 bg-neutral-50 rounded-4xl border-none outline-none focus:ring-2 focus:ring-rose-100 h-44 text-neutral-700 font-medium resize-none shadow-inner"
                        ...
                        <button
                            disabled={loading}
                            className="w-full py-5 bg-black text-white rounded-3xl font-black uppercase tracking-[0.2em] hover:bg-rose-600 active:bg-rose-700 transition-all flex items-center justify-center gap-3 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {loading ? (
